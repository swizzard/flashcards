...
import {
  createCardUserWithExternalAuthId,
  getCardUserByExternalAuthId,
} from 'src/services/cardUsers/cardUsers'
...
export const getCurrentUser = async (
  ...
  let user = await getCardUserByExternalAuthId(extId)
  if (!user) {
    user = await createCardUserWithExternalAuthId(extId)
  }
